...
with tab1:
    ...
    **The parallel to Ward 1:** Raj consolidates the very liberal base. Brown is strong with conservatives. The somewhat liberal and moderate lanes are genuinely contested and Trindade Deramo's best persuasion targets, and the most likely to be undecided. If Trindade Deramo can own that lane on first choice while harvesting RCV transfers from Lynch, Reyes Yanes, and Brown voters, the math closes fast in a ~9,000 ballot electorate.
    """)

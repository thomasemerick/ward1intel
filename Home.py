...
with tab1:
    ...
    **🗳️ Historical Precedent: The Kathryn Garcia Playbook (NYC 2021)**
    ...
    In the June 2021 NYC Democratic mayoral primary, Kathryn Garcia trailed Eric Adams by ~100,000 first-choice votes. She won the somewhat liberal lane while Maya Wiley locked up the hard left and Adams owned moderate/conservative Democrats. But Garcia's ideological compatability on key issues with other candidates made her the consensus second and third choice across ideological lines — Wiley voters ranked her #2 at high rates, and moderate voters who couldn't stomach Adams found Garcia acceptable. This Ward 1 race would be the inverse in terms of political spectrum for the Adams/Wiley dynamic, but does map to the polling position three weeks out of that NY race with Adams -> Raj, Wiley -> Brown, and Trindade Deramo -> Garcia. After all RCV rounds, Garcia lost by fewer than 8,000 votes. However, there are two additional minor candidates each polling close to 10% among decided voters in the recent PPP poll and Garcia stayed roughly at parity with the other top candidates in those vote transfers. For Trindade Deramo, making inroads with minor candidates' voters as their second choice could produce an even bigger additional boost for a late-surging candidate here than it did in the 2021 NYC mayoral race.

    **The parallel to Ward 1:** Raj consolidates the very liberal base. Brown is strong with conservatives. The moderate and somewhat liberal lanes are genuinely contested and Trindade Deramo's best persuasion targets, and the most likely to be undecided. If Trindade Deramo can own that lane on first choice while harvesting RCV transfers from Lynch, Reyes Yanes, and Brown voters, the math closes fast in a ~9,000 ballot electorate.
    """)
